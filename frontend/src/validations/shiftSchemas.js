...
export const newAdminShiftSchema = {
  ...
  // IMPORTANTE: Las claves deben coincidir con los "name" de tus inputs y las claves del formData.
  specialtyId: commonRules.simpleRequired("especialidad"),
  doctorId: commonRules.simpleRequired("médico"),
  date: commonRules.simpleRequired("fecha"),
  time: commonRules.simpleRequired("horario"),
  ...
  membershipNumber: (value) => {
    ...
    // Regex para alfanumérico y guiones
