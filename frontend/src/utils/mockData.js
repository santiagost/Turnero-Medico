...
// --- Médicos (Doctors) ---
export const mockDoctor_Sanchez = { doctorId: 1, licenseNumber: "MP-12345", firstName: "Martin", lastName: "Sanchez", dni: "28111222", telephone: "3515551234", user: { userId: 101, email: "martin.sanchez@vitalis.com", createdAt: "2024-01-10T09:00:00", active: true, role: "Doctor" }, specialty: mockSpecialties[0] };
...
// --- Pacientes (Patients) ---
export const mockPatient_Garcia = { patientId: 1, firstName: "Emiliano", lastName: "García", dni: "11222333", telephone: "3884665015", birthDate: "1987-06-24", membershipNumber: "1111222233334444", user: { userId: 201, email: "emi.garcia@gmail.com", createdAt: "2024-05-15T14:30:00", active: true, role: "Patient" }, socialWork: mockSocialWorks[0] };
export const mockPatient_Martinez = { patientId: 2, firstName: "Sofía", lastName: "Martinez", dni: "22333444", telephone: "3511234567", birthDate: "1995-08-15", membershipNumber: "987654321001", user: { userId: 202, email: "sofia.martinez@gmail.com", createdAt: "2024-06-20T11:00:00", active: true, role: "Patient" }, socialWork: mockSocialWorks[1] };
